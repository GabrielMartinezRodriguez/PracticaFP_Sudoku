...
int buscar(const tListaJugadores & lista, const string &id, bool &Encontrado, int Inicio, int Final);//Busca un id en la lista de jugadores, si este ya esta en la lista devuelve su posicion y si no esta devuelve la posicion en la que deveria ir
